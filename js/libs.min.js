! function (t) {
  ...
  s = 0, (r = function (t, e) {
    ...
    if (!0 === n.options.centerMode ? i = !0 === n.options.infinite ? (e = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (e = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (e = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, i = Math.ceil(e + n.options.slidesToShow), !0 === n.options.fade && (0 < e && e--, i <= n.slideCount && i++)), t = n.$slider.find(".slick-slide").slice(e, i), "anticipated" === n.options.lazyLoad)
      for (var s = e - 1, r = i, l = n.$slider.find(".slick-slide"), a = 0; a < n.options.slidesToScroll; a++) s < 0 && (s = n.slideCount - 1), t = (t = t.add(l.eq(s))).add(l.eq(r)), s--, r++;
    ...
    l.length ? (e = l.first(), i = e.attr("data-lazy"), o = e.attr("data-srcset"), s = e.attr("data-sizes") || r.$slider.attr("data-sizes"), (n = document.createElement("img")).onload = function () {
    ...
    }, n.src = i) : r.$slider.trigger("all../imagesLoaded", [r])
...
function (t, e, i, o) {
  ...
  }) : "object" == typeof exports ? module.exports = o(e, i) : e.fullpage = o(e, i)
  ...
  function Ti(t, e) {
    return (e = 1 < arguments.length ? e : De) ? e.querySelectorAll(t) : null
  }
  ...
  function bi(t) {
    ...
    for (var e = 1, i = arguments.length; e < i; ++e) {
      var o = arguments[e];
      if (o)
        for (var s in o) o.hasOwnProperty(s) && ("[object Object]" !== Object.prototype.toString.call(o[s]) ? t[s] = o[s] : t[s] = bi(t[s], o[s]))
    }
    return t
  }
  ...
  function xi() {
    return "innerHeight" in _e ? _e.innerHeight : De.documentElement.offsetHeight
  }
  ...
  function Oi(t, e) {
    t = n(t) ? t[0] : t;
    for (var i = null != e ? Ti(e, t.parentNode) : t.parentNode.childNodes, o = 0, s = 0; s < i.length; s++) {
      if (i[s] == t) return o;
      1 == i[s].nodeType && o++
    }
    return -1
  ...
  function Yi(t, e) {
    ...
    for (var i = e.split(" "), o = 0; o < i.length; o++) {
      ...
      for (var s = 0; s < t.length; s++) {
        var n = t[s];
        n.classList ? n.classList.remove(e) : n.className = n.className.replace(new RegExp("(^|\\b)" + e.split(" ").join("|") + "(\\b|$)", "gi"), " ")
      }
    }
    return t
  }
  ...
  function o(t, e, i) {
    ...
    for (var s = 0; s < t.length; s++) {
      var n = t[s];
      (!i || s) && i || (o = e.cloneNode(!0), n.parentNode.insertBefore(o, n)), o.appendChild(n)
    }
    return t
  }
  ...
  function Di(t, e) {
    for ("string" == typeof e && (e = Zi(e)), t.appendChild(e); t.firstChild !== e;) e.appendChild(t.firstChild)
  }

  function Wi(t) {
    for (var e = De.createDocumentFragment(); t.firstChild;) e.appendChild(t.firstChild);
    t.parentNode.replaceChild(e, t)
  }

  function Bi(t, e) {
    return t && 1 === t.nodeType ? Ki(t, e) ? t : Bi(t.parentNode, e) : null
  }
  ...
  function Vi(t, e, i) {
    var o;
    i = void 0 === i ? {} : i, "function" == typeof _e.CustomEvent ? o = new CustomEvent(e, {
      detail: i
    }) : (o = De.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, i), t.dispatchEvent(o)
  }
  ...
  function l(t, e, i) {
    for (var o = t[i], s = []; o;) !Ki(o, e) && null != e || s.push(o), o = o[i];
    return s
  }
  ...
  return _e.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (t, e) {
      e = e || _e;
    ...
    function (t, m) {
      var i = m && new RegExp("([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$").test(m.licenseKey) || -1 < De.domain.indexOf("alvarotrigo.com"),
        s = Ti("html, body"),
        r = Ti("html")[0],
        y = Ti("body")[0];
      if (!ki(r, qe)) {
        ...
        m = bi({
          ...
          scrollOverflowHandler: _e.fp_scrolloverflow ? _e.fp_scrolloverflow.iscrollHandler : null,
        ...
        var S, n, c, o, a = !1,
          d = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),
          p = "ontouchstart" in _e || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints,
        ...
        v.k = bi({}, v.m);
        var g, k, x, E, C, $, P, A, L, H = function () {
            var t;
            t = _e.PointerEvent ? {
              down: "pointerdown",
              move: "pointermove"
        ...
        try {
          ...
          _e.addEventListener("testPassive", null, X), _e.removeEventListener("testPassive", null, X)
        } catch (t) {}
        var Y, I, _, D = bi({}, m),
          W = !1,
          B = !0,
          j = ["parallax", "scrollOverflowReset", "dragAndMove", "offsetSections", "fadingEffect", "responsiveSlides", "continuousHorizontal", "interlockedSlides", "scrollHorizontally", "resetSliders", "cards"];
        Oe(), _e.fp_easings = bi(_e.fp_easings, {
          easeInOutCubic: function (t, e, i, o) {
            return (t /= o / 2) < 1 ? i / 2 * t * t * t + e : i / 2 * ((t -= 2) * t * t + 2) + e
          }
        }), h && (l.version = "3.0.8", l.setAutoScrolling = J, l.setRecordHistory = tt, l.setScrollingSpeed = et, l.setFitToSection = it, l.setLockAnchors = function (t) {
          m.lockAnchors = t
        }, l.setMouseWheelScrolling = ot, l.setAllowScrolling = st, l.setKeyboardScrolling = rt, l.moveSectionUp = lt, l.moveSectionDown = at, l.silentMoveTo = ct, l.moveTo = dt, l.moveSlideRight = pt, l.moveSlideLeft = ht, l.fitToSection = Ct, l.reBuild = ut, l.setResponsive = vt, l.getFullpageData = function () {
          return m
        }, l.destroy = function (t) {
          J(!1, "internal"), st(!0), nt(!1), rt(!1), Xi(h, Ne), [C, E, k, $, P, L, x, _].forEach(function (t) {
            clearTimeout(t)
          }), _e.removeEventListener("scroll", Et), _e.removeEventListener("hashchange", Zt), _e.removeEventListener("resize", ce), De.removeEventListener("keydown", Jt), De.removeEventListener("keyup", te), ["click", "touchstart"].forEach(function (t) {
            De.removeEventListener(t, gt)
          }), ["mouseenter", "touchstart", "mouseleave", "touchend"].forEach(function (t) {
            De.removeEventListener(t, yt, !0)
          }), t && (Pe(0), Ti("img[data-src], source[data-src], audio[data-src], iframe[data-src]", h).forEach(function (t) {
            jt(t, "src")
          }), Ti("img[data-srcset]").forEach(function (t) {
            jt(t, "srcset")
          }), Gi(Ti(oi + ", " + fi + ", " + gi)), Ci(Ti(Ze), {
            height: "",
            "background-color": "",
            padding: ""
          }), Ci(Ti(ri), {
            ...
            overflow: "",
            height: ""
          }), Yi(r, qe), Yi(y, je), y.className.split(/\s+/).forEach(function (t) {
            0 === t.indexOf(Fe) && Yi(y, t)
          }), Ti(Ze + ", " + ri).forEach(function (t) {
            m.scrollOverflowHandler && m.scrollOverflow && m.scrollOverflowHandler.remove(t), Yi(t, hi + " " + Ue + " " + Ke), t.getAttribute("data-fp-styles") && t.setAttribute("style", t.getAttribute("data-fp-styles")), ki(t, Qe) && !W && t.removeAttribute("data-anchor")
          }), ue(h), [ti, pi, ci].forEach(function (t) {
            ...
            transition: "none"
          }), _e.scrollTo(0, 0), [Qe, ni, di].forEach(function (t) {
            Yi(Ti("." + t), t)
          }))
          ...
          translate3dH: function () {
            for (var t = [], e = 0; e < Ti(m.sectionSelector, h).length; e++) t.push("translate3d(0px, 0px, 0px)");
            return t
          }(),
          left: function () {
            for (var t = [], e = 0; e < Ti(m.sectionSelector, h).length; e++) t.push(0);
            return t
          }(),
          options: m,
          setAutoScrolling: J
        ...
        }, _e.fullpage_api = l, m.$ && Object.keys(l).forEach(function (t) {
          m.$.fn.fullpage[t] = l[t]
        }), function () {
          m.css3 && (m.css3 = function () {
            var t, e = De.createElement("p"),
              i = {
            ...
            for (var o in e.style.display = "block", De.body.insertBefore(e, null), i) void 0 !== e.style[o] && (e.style[o] = "translate3d(1px,1px,1px)", t = _e.getComputedStyle(e).getPropertyValue(i[o]));
            return De.body.removeChild(e), void 0 !== t && 0 < t.length && "none" !== t
          }());
          m.scrollBar = m.scrollBar || m.hybrid,
            function () {
              if (!m.anchors.length) {
                var t = "[data-anchor]",
                  e = Ti(m.sectionSelector.split(",").join(t + ",") + t, h);
                e.length && e.length === Ti(Ze).length && (W = !0, e.forEach(function (t) {
                  m.anchors.push(t.getAttribute("data-anchor").toString())
                }))
              }
              if (!m.navigationTooltips.length) {
                var i = "[data-tooltip]",
                  o = Ti(m.sectionSelector.split(",").join(i + ",") + i, h);
                o.length && o.forEach(function (t) {
                  m.navigationTooltips.push(t.getAttribute("data-tooltip").toString())
                })
              }
            }(),
            function () {
              Ci(h, {
                height: "100%",
                position: "relative"
              }), Xi(h, We), Xi(r, qe), w = xi(), Yi(h, Ne), Xi(Ti(m.sectionSelector, h), Qe), Xi(Ti(m.slideSelector, h), ni);
              for (var t = Ti(Ze), e = 0; e < t.length; e++) {
                var i = e,
                  o = t[e],
                  s = Ti(ri, o),
                  n = s.length;
                o.setAttribute("data-fp-styles", o.getAttribute("style")), Tt(o, i), bt(o, i), 0 < n ? wt(o, s, n) : m.verticalCentered && ge(o)
              }
              m.fixedElements && m.css3 && Ti(m.fixedElements).forEach(function (t) {
                y.appendChild(t)
              });
              m.navigation && function () {
                ...
                var i = Ti(oi)[0];
                Xi(i, "fp-" + m.navigationPosition), m.showActiveTooltip && Xi(i, "fp-show-active");
                for (var o = "", s = 0; s < Ti(Ze).length; s++) {
                  var n = "";
                  m.anchors.length && (n = m.anchors[s]), o += '<li><a href="#' + n + '"><span class="fp-sr-only">' + kt(s, "Section") + "</span><span></span></a>";
                  var r = m.navigationTooltips[s];
                  void 0 !== r && "" !== r && (o += '<div class="' + si + " fp-" + m.navigationPosition + '">' + r + "</div>"), o += "</li>"
                }
                Ti("ul", i)[0].innerHTML = o, Xi(Ti("a", Ti("li", Ti(oi)[0])[Oi(Ti(Ge)[0], Ze)]), Ue)
              }();
              Ti('iframe[src*="youtube.com/embed/"]', h).forEach(function (t) {
                ! function (t, e) {
                  var i = t.getAttribute("src");
                  t.setAttribute("src", i + function (t) {
                    return /\?/.test(t) ? "&" : "?"
                  }(i) + e)
                }(t, "enablejsapi=1")
              }), m.scrollOverflow && (g = m.scrollOverflowHandler.init(m))
            }(), st(!0), nt(!0), J(m.autoScrolling, "internal"), pe(), Ee(), "complete" === De.readyState && Qt();
          _e.addEventListener("load", Qt), m.scrollOverflow || xt();
          ! function () {
            for (var t = 1; t < 4; t++) L = setTimeout(St, 350 * t)
          }()
        }(), _e.addEventListener("scroll", Et), _e.addEventListener("hashchange", Zt), _e.addEventListener("focus", se), _e.addEventListener("blur", ne), _e.addEventListener("resize", ce), De.addEventListener("keydown", Jt), De.addEventListener("keyup", te), ["click", "touchstart"].forEach(function (t) {
          De.addEventListener(t, gt)
        }), m.normalScrollElements && (["mouseenter", "touchstart"].forEach(function (t) {
          mt(t, !1)
      ...
      function J(t, e) {
        ...
        var i = Ti(Ge)[0];
        if (m.autoScrolling && !m.scrollBar) Ci(s, {
          overflow: "hidden",
          height: "100%"
        }), tt(D.recordHistory, "internal"), Ci(h, {
          ...
          "touch-action": "none"
            ...
            overflow: "visible",
            height: "initial"
          }), tt(!!m.autoScrolling && D.recordHistory, "internal"), Ci(h, {
            "-ms-touch-action": "",
            "touch-action": ""
          }), null != i) {
      ...
      function ot(t) {
        t ? (function () {
          var t, e = "";
          _e.addEventListener ? t = "addEventListener" : (t = "attachEvent", e = "on");
          var i = "onwheel" in De.createElement("div") ? "wheel" : void 0 !== De.onmousewheel ? "mousewheel" : "DOMMouseScroll",
            o = !!z && {
              passive: !1
            };
          "DOMMouseScroll" == i ? De[t](e + "MozMousePixelScroll", Mt, o) : De[t](e + i, Mt, o)
        }(), h.addEventListener("mousedown", ee), h.addEventListener("mouseup", ie)) : (De.addEventListener ? (De.removeEventListener("mousewheel", Mt, !1), De.removeEventListener("wheel", Mt, !1), De.removeEventListener("MozMousePixelScroll", Mt, !1)) : De.detachEvent("onmousewheel", Mt), h.removeEventListener("mousedown", ee), h.removeEventListener("mouseup", ie))
      }
      ...
      function nt(t) {
        t ? (ot(!0), function () {
          if (d || p) {
            m.autoScrolling && (y.removeEventListener(O.touchmove, Pt, {
              passive: !1
            }), y.addEventListener(O.touchmove, Pt, {
              passive: !1
            }));
            var t = m.touchWrapper;
            t.removeEventListener(O.touchstart, Ht), t.removeEventListener(O.touchmove, At, {
              passive: !1
            }), t.addEventListener(O.touchstart, Ht), t.addEventListener(O.touchmove, At, {
              passive: !1
            })
          }
        }()) : (ot(!1), function () {
          if (d || p) {
            m.autoScrolling && (y.removeEventListener(O.touchmove, At, {
              passive: !1
      ...
      function lt() {
        var t = $i(Ti(Ge)[0], Ze);
        t || !m.loopTop && !m.continuousVertical || (t = Hi(Ti(Ze))), null != t && Yt(t, null, !0)
      }

      function at() {
        var t = Pi(Ti(Ge)[0], Ze);
        t || !m.loopBottom && !m.continuousVertical || (t = Ti(Ze)[0]), null != t && Yt(t, null, !1)
      }
      ...
      function ut(t) {
        if (!ki(h, Ne)) {
          ...
          var r = Oi(Ti(Ge)[0], Ze);
          r && ct(r + 1), T = !1, Ui(m.afterResize) && t && m.afterResize.call(h, _e.innerWidth, _e.innerHeight), Ui(m.afterReBuild) && !t && m.afterReBuild.call(h)
        }
      }
      ...
      function vt(t) {
        var e = ft();
        t ? e || (J(!1, "internal"), it(!1, "internal"), Mi(Ti(oi)), Xi(y, je), Ui(m.afterResponsive) && m.afterResponsive.call(h, t), m.scrollOverflow && g.createScrollBarForAll()) : e && (J(D.autoScrolling, "internal"), it(D.autoScrolling, "internal"), zi(Ti(oi)), Yi(y, je), Ui(m.afterResponsive) && m.afterResponsive.call(h, t))
      }

      function gt(t) {
        var e = t.target;
        e && Bi(e, oi + " a") ? function (t) {
          Fi(t);
          var e = Oi(Bi(this, oi + " li"));
          Yt(Ti(Ze)[e])
        }.call(e, t) : Ki(e, ".fp-tooltip") ? function () {
          Vi(Ai(this), "click")
        }.call(e) : Ki(e, gi) ? function () {
          var t = Bi(this, Ze);
          ki(this, mi) ? v.m.left && ht(t) : v.m.right && pt(t)
        }.call(e, t) : Ki(e, vi) || null != Bi(e, vi) ? function (t) {
          Fi(t);
          var e = Ti(ci, Bi(this, Ze))[0],
            i = Ti(ri, e)[Oi(Bi(this, "li"))];
          le(e, i)
        }.call(e, t) : Bi(e, m.menu + " [data-menuanchor]") && function (t) {
          !Ti(m.menu)[0] || !m.lockAnchors && m.anchors.length || (Fi(t), dt(this.getAttribute("data-menuanchor")))
        }.call(e, t)
      }
      ...
      function yt(t) {
        var e = t.type,
          o = !1,
          s = m.scrollOverflow,
          n = "mouseleave" === e ? t.toElement || t.relatedTarget : t.target;
        if (n == De || !n) return nt(!0), void(s && m.scrollOverflowHandler.setIscroll(n, !0));
        "touchend" === e && (B = !1, setTimeout(function () {
          B = !0
        }, 800)), "mouseenter" === e && !B || (m.normalScrollElements.split(",").forEach(function (t) {
          if (!o) {
            var e = Ki(n, t),
              i = Bi(n, t);
            (e || i) && (l.shared.isNormalScrollElement || (nt(!1), s && m.scrollOverflowHandler.setIscroll(n, !1)), l.shared.isNormalScrollElement = !0, o = !0)
          }
        }), !o && l.shared.isNormalScrollElement && (nt(!0), s && m.scrollOverflowHandler.setIscroll(n, !0), l.shared.isNormalScrollElement = !1))
      }
      ...
      function wt(t, e, i) {
        ...
        r.className = di, _i(e, r), Ci(Ti(pi, t), {
          width: o + "%"
        }), 1 < i && (m.controlArrows && function (t) {
          var e = [Zi('<div class="fp-controlArrow fp-prev"></div>'), Zi('<div class="fp-controlArrow fp-next"></div>')];
          ji(Ti(ci, t)[0], e), "#fff" !== m.controlArrowColor && (Ci(Ti(Si, t), {
            "border-color": "transparent transparent transparent " + m.controlArrowColor
          }), Ci(Ti(yi, t), {
            "border-color": "transparent " + m.controlArrowColor + " transparent transparent"
          }));
          m.loopHorizontal || Mi(Ti(yi, t))
        }(t), m.slidesNavigation && function (t, e) {
          Ii(Zi('<div class="' + ui + '"><ul></ul></div>'), t);
          var i = Ti(fi, t)[0];
          Xi(i, "fp-" + m.slidesNavPosition);
          for (var o = 0; o < e; o++) {
            var s = Ti(ri, t)[o];
            Ii(Zi('<li><a href="#"><span class="fp-sr-only">' + kt(o, "Slide", s) + "</span><span></span></a></li>"), Ti("ul", i)[0])
          }
          Ci(i, {
            "margin-left": "-" + i.innerWidth / 2 + "px"
          }), Xi(Ti("a", Ti("li", i)[0]), Ue)
        }(t, i)), e.forEach(function (t) {
          Ci(t, {
            width: s + "%"
          }), m.verticalCentered && ge(t)
        });
        var l = Ti(li, t)[0];
        null != l && (0 !== Oi(Ti(Ge), Ze) || 0 === Oi(Ti(Ge), Ze) && 0 !== Oi(l)) ? $e(l, "internal") : Xi(e[0], Ue)
      }

      function Tt(t, e) {
        e || null != Ti(Ge)[0] || Xi(t, Ue), o = Ti(Ge)[0], Ci(t, {
          height: w + "px"
        }), m.paddingTop && Ci(t, {
          "padding-top": m.paddingTop
        }), m.paddingBottom && Ci(t, {
          "padding-bottom": m.paddingBottom
        }), void 0 !== m.sectionsColor[e] && Ci(t, {
          "background-color": m.sectionsColor[e]
        }), void 0 !== m.anchors[e] && t.setAttribute("data-anchor", m.anchors[e])
      }

      function bt(t, e) {
        void 0 !== m.anchors[e] && ki(t, Ue) && fe(m.anchors[e], e), m.menu && m.css3 && null != Bi(Ti(m.menu)[0], Be) && Ti(m.menu).forEach(function (t) {
          y.appendChild(t)
        })
      }

      function kt(t, e, i) {
        var o = "Section" === e ? m.anchors[t] : i.getAttribute("data-anchor");
        return m.navigationTooltips[t] || o || e + " " + (t + 1)
      }

      function xt() {
        var t = Ti(Ge)[0];
        Xi(t, Ke), Nt(t), Rt(), Ft(t), m.scrollOverflow && m.scrollOverflowHandler.afterLoad(),
          function () {
            var t = Gt(),
              e = Se(t.section);
            return !t.section || !e || void 0 !== e && Oi(e) === Oi(o)
          }() && Ui(m.afterLoad) && It("afterLoad", {
            activeSection: t,
            element: t,
            direction: null,
      ...
      function Et() {
        ...
        if (!T && (!m.autoScrolling || m.scrollBar)) {
          ...
          if (! function (t) {
            ...
            }(i) || ki(Ti(Ge)[0], Ke) || (Xi(Ti(Ge)[0], Ke), Yi(qi(Ti(Ge)[0]), Ke)), !ki(t = r[o], Ue)) {
            R = !0;
            var a, c, d = Ti(Ge)[0],
              p = Oi(d, Ze) + 1,
              h = ve(t),
            ...
            v && (c = v.getAttribute("data-anchor"), a = Oi(v)), b && (Xi(t, Ue), Yi(qi(t), Ue), Ui(m.onLeave) && It("onLeave", g), Ui(m.afterLoad) && It("afterLoad", g), Vt(d), Nt(t), Ft(t), fe(u, f - 1), m.anchors.length && (S = u), be(a, c, u, f)), clearTimeout($), $ = setTimeout(function () {
              R = !1
            }, 100)
          }
          m.fitToSection && (clearTimeout(P), P = setTimeout(function () {
        ...
        if (v.m[t]) {
          ...
          if (m.scrollOverflow) {
            var i = m.scrollOverflowHandler.scrollable(Ti(Ge)[0]),
              o = "down" === t ? "bottom" : "top";
            if (null != i) {
              if (!m.scrollOverflowHandler.isScrolled(o, i)) return !0;
              e()
            } else e()
          } else e()
        }
      ...
      function At(t) {
        ...
        if (Lt(t)) {
          ...
          var i = Ce(t);
          U = i.y, V = i.x, Ti(ci, e).length && Math.abs(F - V) > Math.abs(q - U) ? !a && Math.abs(F - V) > Ei() / 100 * m.touchSensitivity && (V < F ? v.m.right && pt(e) : v.m.left && ht(e)) : m.autoScrolling && b && Math.abs(q - U) > _e.innerHeight / 100 * m.touchSensitivity && (U < q ? $t("down") : q < U && $t("up"))
        }
      }
      ...
      function Ot(t, e) {
        for (var i = 0, o = t.slice(Math.max(t.length - e, 1)), s = 0; s < o.length; s++) i += o[s];
      ...
      function Mt(t) {
        ...
        if (m.autoScrolling && !c && !i) {
          var o = (t = t || _e.event).wheelDelta || -t.deltaY || -t.detail,
            s = Math.max(-1, Math.min(1, o)),
            n = void 0 !== t.wheelDeltaX || void 0 !== t.deltaX,
            r = Math.abs(t.wheelDeltaX) < Math.abs(t.wheelDelta) || Math.abs(t.deltaX) < Math.abs(t.deltaY) || !n;
          149 < f.length && f.shift(), f.push(Math.abs(o)), m.scrollBar && Fi(t);
          var l = e - K;
          if (K = e, 200 < l && (f = []), b) {
            var a = Ot(f, 10);
      ...
      function Xt() {
        for (var t = Ti(li), e = 0; e < t.length; e++) $e(t[e], "internal")
      }
        ...
        if (null != t) {
          var o, s, n = {
            ...
            dtop: function (t) {
              ...
              return w < e ? (s || r) && "bottom" !== r || (o = n) : (s || T && null == Li(t)) && (o = n), Q = o
            }(t),
            yMovement: ve(t),
            anchorLink: t.getAttribute("data-anchor"),
            sectionIndex: Oi(t, Ze),
          ...
          if (!(n.activeSection == t && !T || m.scrollBar && Ni() === n.dtop && !ki(t, ei))) {
            if (null != n.activeSlide && (o = n.activeSlide.getAttribute("data-anchor"), s = Oi(n.activeSlide)), !n.localIsResizing) {
              var r = n.yMovement;
              if (void 0 !== i && (r = i ? "up" : "down"), n.direction = r, Ui(m.onLeave) && !1 === It("onLeave", n)) return
            }
            m.autoScrolling && m.continuousVertical && void 0 !== n.isMovementUp && (!n.isMovementUp && "up" == n.yMovement || n.isMovementUp && "down" == n.yMovement) && (n = function (t) {
                t.isMovementUp ? Ri(Ti(Ge)[0], Ji(t.activeSection, Ze)) : ji(Ti(Ge)[0], to(t.activeSection, Ze).reverse());
                return Pe(Ti(Ge)[0].offsetTop), Xt(), t.wrapAroundElements = t.activeSection, t.dtop = t.element.offsetTop, t.yMovement = ve(t.element), t
              }(n)), n.localIsResizing || Vt(n.activeSection), m.scrollOverflow && m.scrollOverflowHandler.beforeLeave(), Xi(t, Ue), Yi(qi(t), Ue), Nt(t), m.scrollOverflow && m.scrollOverflowHandler.onLeave(), b = l.test.isTesting, be(s, o, n.anchorLink, n.sectionIndex),
              function (t) {
                var e = m.scrollingSpeed < 700,
                  i = e ? 700 : m.scrollingSpeed;
                if (m.css3 && m.autoScrolling && !m.scrollBar) {
                  ye("translate3d(0px, -" + Math.round(t.dtop) + "px, 0px)", !0), m.scrollingSpeed ? (clearTimeout(E), E = setTimeout(function () {
                    Bt(t), b = !e
                  }, m.scrollingSpeed)) : Bt(t)
                } else {
                  var o = Wt(t.dtop);
                  l.test.top = -t.dtop + "px", Me(o.element, o.options, m.scrollingSpeed, function () {
                    m.scrollBar ? setTimeout(function () {
                      Bt(t)
                    }, 30) : (Bt(t), b = !e)
                  })
                }
                e && (clearTimeout(_), _ = setTimeout(function () {
                  b = !0
                }, i))
              }(n), S = n.anchorLink, fe(n.anchorLink, n.sectionIndex)
          }
        }
      }
      ...
      function It(t, e) {
        ...
        } else if (Vi(h, t, i), !1 === m[t].apply(i[Object.keys(i)[0]], function (e) {
      ...
      function Wt(t) {
        var e = {};
        return m.autoScrolling && !m.scrollBar ? (e.options = -t, e.element = Ti(Be)[0]) : (e.options = t, e.element = _e), e
      }

      function Bt(t) {
        ! function (t) {
          null != t.wrapAroundElements && (t.isMovementUp ? Ri(Ti(Ze)[0], t.wrapAroundElements) : ji(Ti(Ze)[Ti(Ze).length - 1], t.wrapAroundElements), Pe(Ti(Ge)[0].offsetTop), Xt())
        }(t), Ui(m.afterLoad) && !t.localIsResizing && It("afterLoad", t), m.scrollOverflow && m.scrollOverflowHandler.afterLoad(), t.localIsResizing || Ft(t.element), Xi(t.element, Ke), Yi(qi(t.element), Ke), Rt(), b = !0, Ui(t.callback) && t.callback()
      }
      ...
      function Rt() {
        var t = Ti(".fp-auto-height")[0] || ft() && Ti(".fp-auto-height-responsive")[0];
        m.lazyLoading && t && Ti(Ze + ":not(" + Ve + ")").forEach(function (t) {
          ! function (t) {
      ...
      function Nt(o) {
        m.lazyLoading && Ti("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", Kt(o)).forEach(function (i) {
          if (["src", "srcset"].forEach(function (t) {
              var e = i.getAttribute("data-" + t);
              null != e && e && (jt(i, t), i.addEventListener("load", function () {
                qt(o)
              }))
            }), Ki(i, "source")) {
      ...
      function qt(t) {
        m.scrollOverflow && (clearTimeout(I), I = setTimeout(function () {
      ...
      function Ft(t) {
        ...
        }), Ti('iframe[src*="youtube.com/embed/"]', e).forEach(function (t) {
          t.hasAttribute("data-autoplay") && Ut(t), t.onload = function () {
      ...
      function Zt() {
        if (!R && !m.lockAnchors) {
          ...
          e && e.length && (e && e !== S && !o || s || !a && n != i) && we(e, i)
        }
      }

      function Gt() {
        var t, e, i = _e.location.hash;
        if (i.length) {
      ...
      function Jt(t) {
        ...
        if (9 === i) ! function (t) {
          ...
          i ? null == Bi(i, Ge + "," + Ge + " " + li) && (i = s(t)) : s(t);
          (!e && i == o[o.length - 1] || e && i == o[0]) && Fi(t)
        }(t);
        else if (!Ki(e, "textarea") && !Ki(e, "input") && !Ki(e, "select") && "true" !== e.getAttribute("contentEditable") && "" !== e.getAttribute("contentEditable") && m.keyboardScrolling && m.autoScrolling) {
          -1 < [40, 38, 32, 33, 34].indexOf(i) && Fi(t), c = t.ctrlKey, A = setTimeout(function () {
            ! function (t) {
              var e = t.shiftKey,
                i = De.activeElement,
      ...
      function ee(t) {
        2 == t.which && (Z = t.pageY, h.addEventListener("mousemove", re))
      }
      ...
      function re(t) {
        m.autoScrolling && (b && (t.pageY < Z && v.m.up ? lt() : t.pageY > Z && v.m.down && at()), Z = t.pageY)
      }
      ...
      function le(t, e, i) {
        ...
        s.xMovement = function (t, e) {
          ...
          if (e < t) return "left";
          return "right"
        }(s.prevSlideIndex, s.slideIndex), s.direction = s.direction ? s.direction : s.xMovement, s.localIsResizing || (b = !1), m.onSlideLeave && !s.localIsResizing && "none" !== s.xMovement && Ui(m.onSlideLeave) && !1 === It("onSlideLeave", s) ? a = !1 : (Xi(e, Ue), Yi(qi(e), Ue), s.localIsResizing || (Vt(s.prevSlide), Nt(e)), !m.loopHorizontal && m.controlArrows && (Qi(Ti(yi, o), 0 !== s.slideIndex), Qi(Ti(Si, o), null != Li(e))), ki(o, Ue) && !s.localIsResizing && be(s.slideIndex, s.slideAnchor, s.anchorLink, s.sectionIndex), function (t, e, i) {
          var o = e.destinyPos;
          if (m.css3) {
            var s = "translate3d(-" + Math.round(o.left) + "px, 0px, 0px)";
            l.test.translate3dH[e.sectionIndex] = s, Ci(he(Ti(pi, t)), Ae(s)), C = setTimeout(function () {
              i && ae(e)
            }, m.scrollingSpeed)
          } else l.test.left[e.sectionIndex] = Math.round(o.left), Me(t, Math.round(o.left), m.scrollingSpeed, function () {
            i && ae(e)
          })
        }(t, s, !0))
      }
      ...
      function ae(t) {
        ! function (t, e) {
          m.slidesNavigation && null != t && (Yi(Ti(Ve, t), Ue), Xi(Ti("a", Ti("li", t)[e]), Ue))
        }(t.slidesNav, t.slideIndex), t.localIsResizing || (Ui(m.afterSlideLoad) && It("afterSlideLoad", t), b = !0, Ft(t.destiny)), a = !1
      }

      function ce() {
        T = !0, clearTimeout(k), k = setTimeout(function () {
      ...
      function de() {
        if (pe(), d) {
          ...
          if (!Ki(t, "textarea") && !Ki(t, "input") && !Ki(t, "select")) {
            var e = xi();
            Math.abs(e - G) > 20 * Math.max(G, e) / 100 && (ut(!0), G = e)
          }
        } else St()
      }
      ...
      function fe(t, e) {
        ! function (e) {
          Ti(m.menu).forEach(function (t) {
            m.menu && null != t && (Yi(Ti(Ve, t), Ue), Xi(Ti('[data-menuanchor="' + e + '"]', t), Ue))
          })
        }(t),
        function (t, e) {
          m.navigation && null != Ti(oi)[0] && (Yi(Ti(Ve, Ti(oi)[0]), Ue), Xi(t ? Ti('a[href="#' + t + '"]', Ti(oi)[0]) : Ti("a", Ti("li", Ti(oi)[0])[e]), Ue))
        }(t, e)
      }
      ...
      function ge(t) {
        if (!ki(t, hi)) {
          var e = De.createElement("div");
          e.className = Je, e.style.height = me(t) + "px", Xi(t, hi), Di(t, e)
        }
      }
      ...
      function ye(t, e) {
        e ? he(h) : ue(h), Ci(h, Ae(t)), l.test.translate3d = t, setTimeout(function () {
          Yi(h, Re)
        }, 10)
      }
      ...
      function we(t, e) {
        ...
        if (null != i) {
          var o = function (t, e) {
            ...
            return null == i && (t = void 0 !== t ? t : 0, i = Ti(ri, e)[t]), i
          }(e, i);
          xe(i) === S || ki(i, Ue) ? Te(o) : Yt(i, function () {
            Te(o)
          })
        }
      }
      ...
      function be(t, e, i) {
        var o = "";
        m.anchors.length && !m.lockAnchors && (t ? (null != i && (o = i), null == e && (e = t), ke(o + "/" + (n = e))) : (null != t && (n = e), ke(i))), Ee()
      }

      function ke(t) {
        if (m.recordHistory) location.hash = t;
        else if (d || p) _e.history.replaceState(void 0, void 0, "#" + t);
        else {
      ...
      function Ce(t) {
        var e = [];
        return e.y = void 0 !== t.pageY && (t.pageY || t.pageX) ? t.pageY : t.touches[0].pageY, e.x = void 0 !== t.pageX && (t.pageY || t.pageX) ? t.pageX : t.touches[0].pageX, p && Lt(t) && m.scrollBar && void 0 !== t.touches && (e.y = t.touches[0].pageY, e.x = t.touches[0].pageX), e
      }

      function $e(t, e) {
        et(0, "internal"), void 0 !== e && (T = !0), le(Bi(t, ci), t), void 0 !== e && (T = !1), et(D.scrollingSpeed, "internal")
      }

      function Pe(t) {
        var e = Math.round(t);
        if (m.css3 && m.autoScrolling && !m.scrollBar) ye("translate3d(0px, -" + e + "px, 0px)", !1);
        else if (m.autoScrolling && !m.scrollBar) Ci(h, {
          top: -e + "px"
        }), l.test.top = -e + "px";
        else {
          var i = Wt(e);
      ...
      function Le(e, t, i) {
        "all" !== t ? v[i][t] = e : Object.keys(v[i]).forEach(function (t) {
          v[i][t] = e
        })
      }
      ...
      function Oe() {
        ...
        i ? t && t.length < 20 && (console.warn("%c This website was made using fullPage.js slider. More info on the following website:", e), console.warn("%c https://alvarotrigo.com/fullPage/", e)) : (wi("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"), wi("error", "https://github.com/alvarotrigo/fullPage.js#options.")), ki(r, qe) ? wi("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (m.continuousVertical && (m.loopTop || m.loopBottom) && (m.continuousVertical = !1, wi("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !m.scrollOverflow || !m.scrollBar && m.autoScrolling || wi("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !m.continuousVertical || !m.scrollBar && m.autoScrolling || (m.continuousVertical = !1, wi("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), m.scrollOverflow && null == m.scrollOverflowHandler && (m.scrollOverflow = !1, wi("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), j.forEach(function (t) {
          ...
          if (i.length || t.length) {
            wi("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).");
            var o = i.length ? "id" : "name";
            (i.length || t.length) && wi("error", '"' + e + '" is is being used by another element `' + o + "` property")
          }
        }))
      }
      ...
      function Me(e, i, o, s) {
        var n = function (t) {
            return t.self != _e && ki(t, ai) ? t.scrollLeft : !m.autoScrolling || m.scrollBar ? Ni() : t.offsetTop
          }(e),
          r = i - n,
          l = 0;
        Y = !0;
        var a = function () {
          if (Y) {
            var t = i;
            l += 20, o && (t = _e.fp_easings[m.easing](l, n, r, o)), ze(e, t), l < o ? setTimeout(a, 20) : void 0 !== s && s()
          } else l < o && s()
        };
        a()
      }
      ...
      function ze(t, e) {
        !m.autoScrolling || m.scrollBar || t.self != _e && ki(t, ai) ? t.self != _e && ki(t, ai) ? t.scrollLeft = e : t.scrollTo(0, e) : t.style.top = e + "px"
      }

      function Xe(t, e) {
        this.anchor = t.getAttribute("data-anchor"), this.item = t, this.index = Oi(t, e), this.isLast = this.index === t.parentElement.querySelectorAll(e).length - 1, this.isFirst = !this.index
      }
...
}), window.jQuery && window.fullpage && function (e, i) {
    "use strict";
    e && i ? e.fn.fullpage = function (t) {
      t = e.extend({}, t, {
        $: e
      });
      new i(this[0], t)
  ...
  function (r, n, p) {
    var f = r.requestAnimationFrame || r.webkitRequestAnimationFrame || r.mozRequestAnimationFrame || r.oRequestAnimationFrame || r.msRequestAnimationFrame || function (t) {
      ...
      v = function () {
        ...
        o.getTime = Date.now || function () {
          ...
          var r, l, a = t - e,
            c = p.abs(a) / i;
          return l = c / (n = void 0 === n ? 6e-4 : n), (r = t + c * c / (2 * n) * (a < 0 ? -1 : 1)) < o ? (r = s ? o - s / 2.5 * (c / 8) : o, l = (a = p.abs(r - t)) / c) : 0 < r && (r = s ? s / 2.5 * (c / 8) : 0, l = (a = p.abs(t) + r) / c), {
    ...
    function t(t, e) {
      for (var i in this.wrapper = "string" == typeof t ? n.querySelector(t) : t, this.scroller = this.wrapper.children[0], this.scrollerStyle = this.scroller.style, this.options = {
          resizeScrollbars: !0,
          mouseWheelSpeed: 20,
          snapThreshold: .334,
    ...
    function a(t, e) {
      ...
      if (this.sizeRatioX = 1, this.sizeRatioY = 1, this.maxPosX = 0, this.maxPosY = 0, this.options.interactive && (this.options.disableTouch || (v.addEvent(this.indicator, "touchstart", this), v.addEvent(r, "touchend", this)), this.options.disablePointer || (v.addEvent(this.indicator, v.prefixPointerEvent("pointerdown"), this), v.addEvent(r, v.prefixPointerEvent("pointerup"), this)), this.options.disableMouse || (v.addEvent(this.indicator, "mousedown", this), v.addEvent(r, "mouseup", this))), this.options.fade) {
    ...
    t.prototype = {
      ...
      _start: function (t) {
        if ((1 == v.eventType[t.type] || 0 === (t.which ? t.button : t.button < 2 ? 0 : 4 == t.button ? 1 : 2)) && this.enabled && (!this.initiated || v.eventType[t.type] === this.initiated)) {
          !this.options.preventDefault || v.isBadAndroid || v.preventDefaultException(t.target, this.options.preventDefaultException) || t.preventDefault();
          var e, i = t.touches ? t.touches[0] : t;
          this.initiated = v.eventType[t.type], this.moved = !1, this.distX = 0, this.distY = 0, this.directionX = 0, this.directionY = 0, this.directionLocked = 0, this.startTime = v.getTime(), this.options.useTransition && this.isInTransition ? (this._transitionTime(), this.isInTransition = !1, e = this.getComputedPosition(), this._translate(p.round(e.x), p.round(e.y)), this._execEvent("scrollEnd")) : !this.options.useTransition && this.isAnimating && (this.isAnimating = !1, this._execEvent("scrollEnd")), this.startX = this.x, this.startY = this.y, this.absStartX = this.x, this.absStartY = this.y, this.pointX = i.pageX, this.pointY = i.pageY, this._execEvent("beforeScrollStart")
        }
      },
      _move: function (t) {
        if (this.enabled && v.eventType[t.type] === this.initiated) {
          ...
          var e, i, o, s, n = t.touches ? t.touches[0] : t,
            ...
            a = v.getTime();
          if (this.pointX = n.pageX, this.pointY = n.pageY, this.distX += r, this.distY += l, o = p.abs(this.distX), s = p.abs(this.distY), !(300 < a - this.endTime && o < 10 && s < 10)) {
            ...
            r = this.hasHorizontalScroll ? r : 0, l = this.hasVerticalScroll ? l : 0, e = this.x + r, i = this.y + l, (0 < e || e < this.maxScrollX) && (e = this.options.bounce ? this.x + r / 3 : 0 < e ? 0 : this.maxScrollX), (0 < i || i < this.maxScrollY) && (i = this.options.bounce ? this.y + l / 3 : 0 < i ? 0 : this.maxScrollY), this.directionX = 0 < r ? -1 : r < 0 ? 1 : 0, this.directionY = 0 < l ? -1 : l < 0 ? 1 : 0, this.moved || this._execEvent("scrollStart"), this.moved = !0, this._translate(e, i), 300 < a - this.startTime && (this.startTime = a, this.startX = this.x, this.startY = this.y)
          }
        }
      },
      _end: function (t) {
        if (this.enabled && v.eventType[t.type] === this.initiated) {
          this.options.preventDefault && !v.preventDefaultException(t.target, this.options.preventDefaultException) && t.preventDefault(), t.changedTouches && t.changedTouches[0];
          var e, i, o = v.getTime() - this.startTime,
            s = p.round(this.x),
            n = p.round(this.y),
            ...
            a = 0,
            c = "";
          if (this.isInTransition = 0, this.initiated = 0, this.endTime = v.getTime(), !this.resetPosition(this.options.bounceTime)) {
            if (this.scrollTo(s, n), !this.moved) return this.options.tap && v.tap(t, this.options.tap), this.options.click && v.click(t), void this._execEvent("scrollCancel");
            if (this._events.flick && o < 200 && r < 100 && l < 100) this._execEvent("flick");
            else {
              if (this.options.momentum && o < 300 && (e = this.hasHorizontalScroll ? v.momentum(this.x, this.startX, o, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                  destination: s,
                  duration: 0
                }, i = this.hasVerticalScroll ? v.momentum(this.y, this.startY, o, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {
                  destination: n,
                  duration: 0
                }, s = e.destination, n = i.destination, a = p.max(e.duration, i.duration), this.isInTransition = 1), this.options.snap) {
                var d = this._nearestSnap(s, n);
                this.currentPage = d, a = this.options.snapSpeed || p.max(p.max(p.min(p.abs(s - d.x), 1e3), p.min(p.abs(n - d.y), 1e3)), 300), s = d.x, n = d.y, this.directionX = 0, this.directionY = 0, c = this.options.bounceEasing
              }
              if (s != this.x || n != this.y) return (0 < s || s < this.maxScrollX || 0 < n || n < this.maxScrollY) && (c = v.ease.quadratic), void this.scrollTo(s, n, a, c);
      ...
      resetPosition: function (t) {
        var e = this.x,
          i = this.y;
        return t = t || 0, !this.hasHorizontalScroll || 0 < this.x ? e = 0 : this.x < this.maxScrollX && (e = this.maxScrollX), !this.hasVerticalScroll || 0 < this.y ? i = 0 : this.y < this.maxScrollY && (i = this.maxScrollY), (e != this.x || i != this.y) && (this.scrollTo(e, i, t, this.options.bounceEasing), !0)
      },
      disable: function () {
        this.enabled = !1
      },
      ...
      refresh: function () {
        this.wrapper.offsetHeight, this.wrapperWidth = this.wrapper.clientWidth, this.wrapperHeight = this.wrapper.clientHeight, this.scrollerWidth = this.scroller.offsetWidth, this.scrollerHeight = this.scroller.offsetHeight, this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.maxScrollY = this.wrapperHeight - this.scrollerHeight, this.hasHorizontalScroll = this.options.scrollX && this.maxScrollX < 0, this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < 0, this.hasHorizontalScroll || (this.maxScrollX = 0, this.scrollerWidth = this.wrapperWidth), this.hasVerticalScroll || (this.maxScrollY = 0, this.scrollerHeight = this.wrapperHeight), this.endTime = 0, this.directionX = 0, this.directionY = 0, this.wrapperOffset = v.offset(this.wrapper), this._execEvent("refresh"), this.resetPosition()
      },
      on: function (t, e) {
      ...
      scrollTo: function (t, e, i, o) {
        o = o || v.ease.circular, this.isInTransition = this.options.useTransition && 0 < i;
        var s = this.options.useTransition && o.style;
        !i || s ? (s && (this._transitionTimingFunction(o.style), this._transitionTime(i)), this._translate(t, e)) : this._animate(t, e, i, o.fn)
      },
      scrollToElement: function (t, e, i, o, s) {
        if (t = t.nodeType ? t : this.scroller.querySelector(t)) {
          var n = v.offset(t);
          n.left -= this.wrapperOffset.left, n.top -= this.wrapperOffset.top, !0 === i && (i = p.round(t.offsetWidth / 2 - this.wrapper.offsetWidth / 2)), !0 === o && (o = p.round(t.offsetHeight / 2 - this.wrapper.offsetHeight / 2)), n.left -= i || 0, n.top -= o || 0, n.left = 0 < n.left ? 0 : n.left < this.maxScrollX ? this.maxScrollX : n.left, n.top = 0 < n.top ? 0 : n.top < this.maxScrollY ? this.maxScrollY : n.top, e = null == e || "auto" === e ? p.max(p.abs(this.x - n.left), p.abs(this.y - n.top)) : e, this.scrollTo(n.left, n.top, e, s)
        }
      },
      _transitionTime: function (t) {
        if (this.options.useTransition) {
          ...
          if (e) {
            if (this.scrollerStyle[e] = t + "ms", !t && v.isBadAndroid) {
            ...
            if (this.indicators)
              for (var o = this.indicators.length; o--;) this.indicators[o].transitionTime(t)
          }
        }
      },
      _transitionTimingFunction: function (t) {
        if (this.scrollerStyle[v.style.transitionTimingFunction] = t, this.indicators)
          for (var e = this.indicators.length; e--;) this.indicators[e].transitionTimingFunction(t)
      },
      _translate: function (t, e) {
        if (this.options.useTransform ? this.scrollerStyle[v.style.transform] = "translate(" + t + "px," + e + "px)" + this.translateZ : (t = p.round(t), e = p.round(e), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = e + "px"), this.x = t, this.y = e, this.indicators)
      ...
      _initIndicators: function () {
        ...
        for (var n = o.length; n--;) this.indicators.push(new a(this, o[n]));
      ...
      _initWheel: function () {
        v.addEvent(this.wrapper, "wheel", this), v.addEvent(this.wrapper, "mousewheel", this), v.addEvent(this.wrapper, "DOMMouseScroll", this), this.on("destroy", function () {
          clearTimeout(this.wheelTimeout), this.wheelTimeout = null, v.removeEvent(this.wrapper, "wheel", this), v.removeEvent(this.wrapper, "mousewheel", this), v.removeEvent(this.wrapper, "DOMMouseScroll", this)
        })
      },
      _wheel: function (t) {
        if (this.enabled) {
          ...
          if (void 0 === this.wheelTimeout && n._execEvent("scrollStart"), clearTimeout(this.wheelTimeout), this.wheelTimeout = setTimeout(function () {
            ...
            }, 400), "deltaX" in t) i = 1 === t.deltaMode ? (e = -t.deltaX * this.options.mouseWheelSpeed, -t.deltaY * this.options.mouseWheelSpeed) : (e = -t.deltaX, -t.deltaY);
          ...
          if (e *= this.options.invertWheelDirection, i *= this.options.invertWheelDirection, this.hasVerticalScroll || (e = i, i = 0), this.options.snap) return o = this.currentPage.pageX, s = this.currentPage.pageY, 0 < e ? o-- : e < 0 && o++, 0 < i ? s-- : i < 0 && s++, void this.goToPage(o, s);
          o = this.x + p.round(this.hasHorizontalScroll ? e : 0), s = this.y + p.round(this.hasVerticalScroll ? i : 0), this.directionX = 0 < e ? -1 : e < 0 ? 1 : 0, this.directionY = 0 < i ? -1 : i < 0 ? 1 : 0, 0 < o ? o = 0 : o < this.maxScrollX && (o = this.maxScrollX), 0 < s ? s = 0 : s < this.maxScrollY && (s = this.maxScrollY), this.scrollTo(o, s, 0)
        }
      },
      _initSnap: function () {
        this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function () {
          ...
          if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
            if (!0 === this.options.snap)
              for (i = p.round(c / 2), o = p.round(d / 2); a > -this.scrollerWidth;) {
                ...
                for (t = (n = this.options.snap).length, e = -1; r < t; r++)(0 === r || n[r].offsetLeft <= n[r - 1].offsetLeft) && (l = 0, e++), this.pages[l] || (this.pages[l] = []), a = p.max(-n[r].offsetLeft, this.maxScrollX), s = p.max(-n[r].offsetTop, this.maxScrollY), i = a - p.round(n[r].offsetWidth / 2), o = s - p.round(n[r].offsetHeight / 2), this.pages[l][e] = {
                  x: a,
                  y: s,
      ...
      _nearestSnap: function (t, e) {
        ...
        var i = 0,
          o = this.pages.length,
          s = 0;
        if (p.abs(t - this.absStartX) < this.snapThresholdX && p.abs(e - this.absStartY) < this.snapThresholdY) return this.currentPage;
        for (0 < t ? t = 0 : t < this.maxScrollX && (t = this.maxScrollX), 0 < e ? e = 0 : e < this.maxScrollY && (e = this.maxScrollY); i < o; i++)
      ...
      goToPage: function (t, e, i, o) {
        ...
        var s = this.pages[t][e].x,
          n = this.pages[t][e].y;
        i = void 0 === i ? this.options.snapSpeed || p.max(p.max(p.min(p.abs(s - this.x), 1e3), p.min(p.abs(n - this.y), 1e3)), 300) : i, this.currentPage = {
          x: s,
          y: n,
          pageX: t,
          pageY: e
      ...
      next: function (t, e) {
        ...
        ++i >= this.pages.length && this.hasVerticalScroll && (i = 0, o++), this.goToPage(i, o, t, e)
      },
      prev: function (t, e) {
        var i = this.currentPage.pageX,
          o = this.currentPage.pageY;
        --i < 0 && this.hasVerticalScroll && (i = 0, o--), this.goToPage(i, o, t, e)
      },
      _initKeys: function (t) {
        ...
        v.addEvent(r, "keydown", this), this.on("destroy", function () {
      ...
      _key: function (t) {
        if (this.enabled) {
          var e, i = this.options.snap,
            ...
            n = v.getTime(),
            r = this.keyTime || 0;
          switch (this.options.useTransition && this.isInTransition && (e = this.getComputedPosition(), this._translate(p.round(e.x), p.round(e.y)), this.isInTransition = !1), this.keyAcceleration = n - r < 200 ? p.min(this.keyAcceleration + .25, 50) : 0, t.keyCode) {
            ...
            case this.options.keyBindings.end:
              o = i ? this.pages.length - 1 : this.maxScrollX, s = i ? this.pages[0].length - 1 : this.maxScrollY;
              break;
          ...
          i ? this.goToPage(o, s) : (0 < o ? (o = 0, this.keyAcceleration = 0) : o < this.maxScrollX && (o = this.maxScrollX, this.keyAcceleration = 0), 0 < s ? (s = 0, this.keyAcceleration = 0) : s < this.maxScrollY && (s = this.maxScrollY, this.keyAcceleration = 0), this.scrollTo(o, s, 0), this.keyTime = n)
        }
      },
      _animate: function (n, r, l, a) {
        ...
        this.isAnimating = !0,
          function t() {
            var e, i, o, s = v.getTime();
            if (u <= s) return c.isAnimating = !1, c._translate(n, r), void(c.resetPosition(c.options.bounceTime) || c._execEvent("scrollEnd"));
            o = a(s = (s - h) / l), e = (n - d) * o + d, i = (r - p) * o + p, c._translate(e, i), c.isAnimating && f(t)
          }()
      },
      ...
      destroy: function () {
        this.options.fadeScrollbars && (clearTimeout(this.fadeTimeout), this.fadeTimeout = null), this.options.interactive && (v.removeEvent(this.indicator, "touchstart", this), v.removeEvent(this.indicator, v.prefixPointerEvent("pointerdown"), this), v.removeEvent(this.indicator, "mousedown", this), v.removeEvent(r, "touchmove", this), v.removeEvent(r, v.prefixPointerEvent("pointermove"), this), v.removeEvent(r, "mousemove", this), v.removeEvent(r, "touchend", this), v.removeEvent(r, v.prefixPointerEvent("pointerup"), this), v.removeEvent(r, "mouseup", this)), this.options.defaultScrollbars && this.wrapper.parentNode.removeChild(this.wrapper)
      },
      _start: function (t) {
      ...
      _move: function (t) {
        var e, i, o, s, n = t.touches ? t.touches[0] : t;
        v.getTime(), this.moved || this.scroller._execEvent("scrollStart"), this.moved = !0, e = n.pageX - this.lastPointX, this.lastPointX = n.pageX, i = n.pageY - this.lastPointY, this.lastPointY = n.pageY, o = this.x + e, s = this.y + i, this._pos(o, s), t.preventDefault(), t.stopPropagation()
      },
      _end: function (t) {
        if (this.initiated) {
          if (this.initiated = !1, t.preventDefault(), t.stopPropagation(), v.removeEvent(r, "touchmove", this), v.removeEvent(r, v.prefixPointerEvent("pointermove"), this), v.removeEvent(r, "mousemove", this), this.scroller.options.snap) {
            var e = this.scroller._nearestSnap(this.scroller.x, this.scroller.y),
              i = this.options.snapSpeed || p.max(p.max(p.min(p.abs(this.scroller.x - e.x), 1e3), p.min(p.abs(this.scroller.y - e.y), 1e3)), 300);
      ...
      transitionTime: function (t) {
        t = t || 0;
        var e = v.style.transitionDuration;
        if (e && (this.indicatorStyle[e] = t + "ms", !t && v.isBadAndroid)) {
      ...
      fade: function (t, e) {
        if (!e || this.visible) {
          ...
          var i = t ? 250 : 500,
            o = t ? 0 : 300;
          t = t ? "1" : "0", this.wrapperStyle[v.style.transitionDuration] = i + "ms", this.fadeTimeout = setTimeout(function (t) {
            this.wrapperStyle.opacity = t, this.visible = +t
          }.bind(this, t), o)
        }
      }
    }, t.utils = v, "undefined" != typeof module && module.exports ? module.exports = t : "function" == typeof define && define.amd ? (define(function () {
      return t
    }), void 0 !== r && (r.IScroll = t)) : r.IScroll = t
  }(window, document, Math),
  function (a, c) {
    a.fp_scrolloverflow = function () {
      a.IScroll || (a.IScroll = module.exports);
      var i = "fp-scrollable",
        n = "." + i,
        h = ".fp-section",
        o = h + ".active",
      ...
      function s() {
        ...
        function i() {
          fp_utils.hasClass(c.body, "fp-responsive") ? e(o) : e(t)
        }
        ...
        function t(t) {
          if (!fp_utils.hasClass(t, "fp-noscroll")) {
            ...
            var e, i, o, s = p.options.scrollOverflowHandler,
              n = s.wrapContent(),
              r = fp_utils.closest(t, h),
              l = s.scrollable(t),
              a = (i = r, null != (o = fp_utils.closest(i, h)) ? parseInt(getComputedStyle(o)["padding-bottom"]) + parseInt(getComputedStyle(o)["padding-top"]) : 0);
            null != l ? e = s.scrollHeight(t) : (e = t.scrollHeight, p.options.verticalCentered && (e = f(u, t)[0].scrollHeight));
            var c = fp_utils.getWindowHeight(),
              d = c - a;
            c < e + a ? null != l ? s.update(t, d) : (p.options.verticalCentered ? (fp_utils.wrapInner(f(u, t)[0], n.scroller), fp_utils.wrapInner(f(u, t)[0], n.scrollable)) : (fp_utils.wrapInner(t, n.scroller), fp_utils.wrapInner(t, n.scrollable)), s.create(t, d, p.iscrollOptions)) : s.remove(t), fp_utils.css(t, {
              overflow: ""
            })
          }
        }
        ...
        function o(t) {
          var e = p.options.scrollOverflowHandler;
          fp_utils.hasClass(fp_utils.closest(t, h), "fp-auto-height-responsive") && e.remove(t)
        }
        p.options = null, p.init = function (t, e) {
          return p.options = t, p.iscrollOptions = e, "complete" === c.readyState && (i(), fullpage_api.shared.afterRenderActions()), a.addEventListener("load", function () {
            i(), fullpage_api.shared.afterRenderActions()
          }), p
        }, p.createScrollBarForAll = i, p.createScrollBar = t
      }
      ...
      var f = null,
        ...
        l = {
          ...
          init: function (t) {
            f = fp_utils.$, r = t;
            var e = "ontouchstart" in a || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints;
            return l.iscrollOptions.click = e, l.hasBeenInit = !0, l.iscrollOptions = fp_utils.deepExtend(l.iscrollOptions, t.scrollOverflowOptions), (new s).init(t, l.iscrollOptions)
          },
          toggleWheel: function (i) {
            f(n, f(o)[0]).forEach(function (t) {
          ...
          setIscroll: function (t, e) {
            if (l.hasBeenInit && t) {
              var i = fp_utils.closest(t, n) || f(n, t) && f(n, t)[0],
                o = e ? "enable" : "disable";
          ...
          create: function (i, o, s) {
            f(n, i).forEach(function (t) {
              fp_utils.css(t, {
                height: o + "px"
              });
              var e = t.fp_iscrollInstance;
              null != e && l.iScrollInstances.forEach(function (t) {
                t.destroy()
              }), e = new IScroll(t, s), l.iScrollInstances.push(e), fp_utils.hasClass(fp_utils.closest(i, h), "active") || e.wheelOff(), t.fp_iscrollInstance = e
            })
          },
          isScrolled: function (t, e) {
            ...
            if ("bottom" === t) {
              var o = l.lastScrollY === i.y;
              return l.lastScrollY = i.y, (o ? 1 : 0) + (0 - i.y) + fp_utils.getScrollTop(e) + e.offsetHeight >= e.scrollHeight
            }
          },
          ...
          remove: function (t) {
            if (null != t) {
              ...
              if (null != e) {
                var i = e.fp_iscrollInstance;
                null != i && i.destroy(), e.fp_iscrollInstance = null, fp_utils.unwrap(f(".fp-scroller", t)[0]), fp_utils.unwrap(f(n, t)[0])
              }
            }
          },
          update: function (t, e) {
            clearTimeout(l.refreshId), l.refreshId = setTimeout(function () {
              l.iScrollInstances.forEach(function (t) {
                t.refresh(), fullpage_api.silentMoveTo(fp_utils.index(f(o)[0]) + 1)
              })
            }, 150), fp_utils.css(f(n, t)[0], {
              height: e + "px"
            }), r.verticalCentered && fp_utils.css(f(n, t)[0].parentNode, {
              height: e + "px"
            })
          },
